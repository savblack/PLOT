...
patterns='eyJhbGciOiJ|-----BEGIN[A-Z ]*PRIVATE KEY-----|SERVICE_ROLE_KEY[[:space:]]*[:=][[:space:]]*.?[A-Za-z0-9._-]{20,}|PGPASSWORD=|sk_live_|rk_live_|whsec_|sk-ant-|AKIA[0-9A-Z]{16}|re_[A-Za-z0-9]{20,}|AIza[0-9A-Za-z_-]{35}|api_key=[0-9a-f]{32}'
