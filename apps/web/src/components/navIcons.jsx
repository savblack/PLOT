/* Shell navigation icons, shared by AppShell (header, tab bar, drawer) and
   AppSidebar. They were inline in AppShell until the sidebar needed the same
   five, which is one copy too many to keep in step by hand. */
