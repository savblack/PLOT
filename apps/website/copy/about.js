...
export const ABOUT_PAGE = {
  meta: {
    title: 'About — plot',
    description: 'plot is a movie and TV journal built for anyone who loves movies and TV. A note from the solo builder behind it.',
  },
  pageLabel: 'About',
  h1: 'About plot',
  ...
  paragraphs: [
    ...
    'I value each and every person who takes the time to sign up and use plot. Any feedback, good or bad, and any feature request or bug you spot is incredibly helpful to me. It\'s the core driver behind every improvement I make in the app. You can share your thoughts anytime via the settings. What has already shipped is on the <a href="/changelog">changelog</a>.',
