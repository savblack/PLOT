...
export const ABOUT_PAGE = {
  ...
  paragraphs: [
    ...
    "PLOT is still early, so if you're using it now, you're an early user too, bugs and all. When something breaks or feels off, tell me. That feedback is what's shaped almost everything here and it's what'll keep shaping it. <strong>I don't take that kind of patience lightly.</strong>",
    'If you enjoy using PLOT, you can support it directly on <a href="https://ko-fi.com/J7P123TYGK" target="_blank" rel="noopener">Ko-fi</a>. It helps cover what it actually costs to run, and it buys me more time to keep building.',
