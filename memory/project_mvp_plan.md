...
| Chunk | Tasks | Goal |
|-------|-------|------|
| 1: Foundation | 1-3 | react-router-dom, LandingPage component, clean routing with /u/:username deferred until public sharing ships |
...
- `/app` → React app
- `/u/:username` → explicit public-profile holding page until sharing is in scope
