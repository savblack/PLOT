...
:root{--ink:#0c0c0c;--paper:#F4F4F5;--pink:#E05578;--mut:#6b6b70;--faint:#a1a1a6;--hair:rgba(12,12,12,0.14);--display:'Gabarito', 'DM Sans', system-ui, sans-serif;--ease:cubic-bezier(0.23,1,0.32,1);}
