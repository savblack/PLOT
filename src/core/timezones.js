/**
 * Static IANA timezone list — used instead of Intl.supportedValuesOf('timeZone')
 * which is unsupported in Hermes (React Native) and older WebView environments.
 *
 * Covers all major inhabited timezones. Update periodically as the IANA database changes.
 */
