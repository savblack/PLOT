// Local week sheet: one readable HTML page of every active post's full copy
// (X / Instagram / Threads / article), card images, the "why" + platform
// targets + sources, per-platform publish status, a paused banner, a
...
const TL = { upcoming: 'Upcoming this week', trending: 'Trending top 10', watch_tonight: 'What to watch tonight', hidden_gem: 'Hidden gem', on_this_day: 'On this day', now_streaming: 'New at home', countdown: 'Countdown', trailer: 'Trailer drop', question: 'Question' };
...
const reason = (p) => {
  ...
  switch (p.post_type) {
    ...
    case 'now_streaming': return p.payload?.home_kind === 'rental'
      ? (t ? `Now at home (rent or buy): ${t}` : 'New to rent or buy today')
