// Product-analytics event names, shared by the web app and the mobile app so a
// funnel built on one platform's events keeps working when the other starts
// emitting them. Names only — each platform owns its own transport
// (apps/web/src/lib/analytics.js, apps/mobile/lib/analytics.ts).
