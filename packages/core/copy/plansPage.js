export const PLANS_PAGE = {
  ...
  lede: 'Start free and keep every movie and show in one place. Go Premium for unlimited lists and a live release calendar in your calendar app.',
  ...
  free: {
    name: 'Free',
    perpetual: 'forever',
    tagline: 'Everything you need to keep track of your watching.',
    highlights: [
  ...
  premium: {
    ...
    highlights: {
      ...
      traktSync: 'Sync your watchlist and history from Trakt',
      calendarFeed: 'Live release calendar in Apple Calendar, Google Calendar or Outlook',
    },
    opening: 'Opening…',
  ...
  comparison: {
    ...
    rows: {
      ...
      calendarFeed: 'Live calendar subscription',
  ...
  faqs: {
    ...
    cancelAnytime: {
      ...
      a: 'Anytime, from Manage subscription in Settings. You keep Premium until the end of the period you already paid for.',
    },
    downgradeLists: {
    ...
    howSyncWorks: {
      ...
      a: 'Connect Plex or Trakt to sync the watchlist and history available from your connected account. Streaming-service coverage depends on your setup.',
    },
  },
